...
Use [phase-0.5-review.xlsx](phase-0.5-review.xlsx) for practical data entry. It contains Instructions, Reviewer Findings, and Summary sheets with validation lists and a 4-of-5 comprehension summary.
