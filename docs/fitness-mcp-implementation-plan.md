...
323 tests pass，全部 dependency-free（Node 20+，無外部套件）。
...
| **保證** | ✅ 是，且更難複製。同證據永遠同決策，理由綁回證據，輸出帶 confidence／signalCoverage／limits | 已驗證（G3 gate、323 tests） |
...
- **Phase 9 驗收**：
  ...
  5. 既有 323 tests 全綠，且新增 dual-era 雙路徑測試
