...
This file is the GitHub public mirror of the canonical Terms:
...
The canonical Terms are reproduced below.
...
Pacevera provides general fitness and training decision support. It converts user-authorized or user-supplied Evidence into a deterministic decision about a planned session. It is not medical advice, diagnosis, treatment, emergency guidance, medical clearance, or a substitute for a qualified professional.
...
- submit data you are not authorized to use; or
