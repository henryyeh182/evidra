...
This policy describes the Pacevera public preview, the v0.5.6 local Google Health connector, and the planned remote deployment boundary. C is not an available public service until its separate release gates are complete.
...
### Local desktop preview — v0.5.6, available in the connector release
...
### B — local Google Health connector — v0.5.6
