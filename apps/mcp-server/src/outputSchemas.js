...
export const outputSchemas = {
  ...
  evidra_decide_session: {
    ...
    "properties": {
      ...
      "todayBrief": {
        "type": "object",
        "description": "Compact UI-ready Today's Brief derived from this Decision, including state, action, evidence window and trace.",
        "properties": {
          "userId": { "type": "string" },
          "date": { "type": "string" },
        ...
        "required": ["userId", "date", "evidence", "state", "decision", "action", "reason", "confidence", "trace"]
      },
      "proposal": {
        "type": "object",
        "nullable": true,
