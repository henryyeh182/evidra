...
import { LOCAL_DECISION_TOOL, LOCAL_PREVIEW_TOOL } from "../../local-engine/src/server.js";
...
test("the hosted and local tools are the same names in runtime, manifest, and public docs", () => {
  ...
  const bundledRuntime = [
    ...hostedRuntime,
    LOCAL_DECISION_TOOL.name,
    LOCAL_PREVIEW_TOOL.name
  ];
