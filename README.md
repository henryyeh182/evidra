...
1. Download `pacevera.mcpb` from [Releases](https://github.com/henryyeh182/evidra/releases).
...
This repository contains the source implementation, MCP transports, schemas, rule packages, evaluation scenarios, and local engine entrypoints.
...
The source repository requires Node.js 20 or newer. See [docs/mcp-server.md](docs/mcp-server.md) for transport and HTTP configuration details.
...
- [MCP Server](docs/mcp-server.md) — MCP transport, tools, HTTP, and OAuth configuration
- [Privacy deployment contract](docs/privacy-deployment-contract.md) — source-repository deployment boundaries
- [Product specification](docs/product-spec.md) — product requirements and concepts
- [Design Manifesto](docs/design-manifesto.md) — design and governance principles
- [Examples](examples/README.md) — sample Evidence and reproducible scenarios

## Support

- Bug reports and technical questions: [GitHub Issues](https://github.com/henryyeh182/evidra/issues)
