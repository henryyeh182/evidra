...
server；本 repo 已補 resource-server/JWT/HTTPS readiness skeleton，但仍卡在真正的
authorization server、公開部署與 hosted 版隱私政策。
...
**這個版本走到哪裡**：目前的發布是 v0.4.2（2026-08-10），v0.1.0 是第一次公開發布。決策邏輯有確定性測試與 eval 覆蓋——
